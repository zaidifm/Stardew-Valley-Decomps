...
{
	[CompilerGenerated]
	private sealed class <GetAllIds>d__3 : IEnumerable<string>, IEnumerable, IEnumerator<string>, IEnumerator, IDisposable
	{
		...
		private List<ModWallpaperOrFlooring>.Enumerator <>7__wrap2;

		private ModWallpaperOrFlooring <set>5__4;
		...
		[MethodImpl(MethodImplOptions.NoInlining)]
		[DebuggerHidden]
		public <GetAllIds>d__3(int <>1__state)
		{
		}
	...
	[MethodImpl(MethodImplOptions.NoInlining)]
	[IteratorStateMachine(typeof(<GetAllIds>d__3))]
