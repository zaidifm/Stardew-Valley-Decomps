...
public class LocationWeather : INetObject<NetFields>
{
	...
	public readonly NetString weather;

	public readonly NetBool isRaining;

	public readonly NetBool isSnowing;

	public readonly NetBool isLightning;

	public readonly NetBool isDebrisWeather;

	public readonly NetBool isGreenRain;

	public readonly NetInt monthlyNonRainyDayCount;
