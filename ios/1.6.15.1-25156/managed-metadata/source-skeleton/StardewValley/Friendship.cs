...
{
	private readonly NetInt points;

	private readonly NetInt giftsThisWeek;

	private readonly NetInt giftsToday;

	private readonly NetRef<WorldDate> lastGiftDate;

	private readonly NetBool talkedToToday;

	private readonly NetBool proposalRejected;

	private readonly NetRef<WorldDate> weddingDate;

	private readonly NetRef<WorldDate> nextBirthingDate;

	private readonly NetEnum<FriendshipStatus> status;

	private readonly NetLong proposer;

	private readonly NetBool roommateMarriage;
