/* 0x06005e34 StardewValley.Menus.MobileScrollbox.setUpForScrollBoxDrawing @ 0x101e1bc2c */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

void SDV_StardewValley_Menus_MobileScrollbox_setUpForScrollBoxDrawing_06005e34
...

{
  ...
  cVar1 = cRam0000000103910c43;
  puVar3 = &uStack_180;
  if (lRam0000000103976fb8 != 0) {
    func_0x00010119b8f8();
  }
  if (cVar1 == '\0') {
    func_0x00010119b908(&UNK_103317570);
    cRam0000000103910c43 = '\x01';
  }
  uVar6 = _UNK_1036a26f8;
  if (param_3 != 0) {
    func_0x00010033199c(param_3);
    lVar4 = *(long *)(param_3 + 0x10);
    uVar6 = _UNK_1036a2700;
    if ((lVar4 != 0) && (uVar6 = _UNK_1036a2708, param_2 != 0)) {
      uVar6 = *(undefined8 *)(lVar4 + 0x1e8);
      *(undefined8 *)(param_2 + 0x70) = *(undefined8 *)(lVar4 + 0x1f0);
      *(undefined8 *)(param_2 + 0x68) = uVar6;
      uVar6 = _UNK_1036a2710;
      if (*(long *)(param_3 + 0x10) != 0) {
        func_0x0001003703a4(*(long *)(param_3 + 0x10),*(undefined8 *)(param_2 + 0x38),
                            *(undefined8 *)(param_2 + 0x40));
        if (param_1 == 1.0) {
          if (*(char *)(lRam00000001038d53e8 + 0x35) == '\0') {
            func_0x0001003319b0();
          }
          uVar6 = *puRam00000001038d53f0;
          if (*(char *)(lRam00000001038d53f8 + 0x35) == '\0') {
            func_0x0001003319b0();
          }
          uVar5 = *(undefined8 *)(param_2 + 0x20);
          puVar3 = &uStack_130;
          uVar7 = *puRam00000001038d5400;
          uStack_128 = 0;
          uStack_130 = 0;
          uStack_118 = 0;
          uStack_120 = 0;
        ...
        func_0x00010033194c(param_3,0,uVar6,uVar7,0,uVar5,0,puVar3);
        return;
      }
    }
  }
  ...
  pcVar2 = (code *)SoftwareBreakpoint(1,0x101e1be44);
  (*pcVar2)();
}
