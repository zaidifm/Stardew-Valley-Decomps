/* 0x0600674e StardewValley.Mobile.VirtualJoypad.TappedButtonB @ 0x101fd4598 */

/* WARNING: Globals starting with '_' overlap smaller symbols at the same address */

bool SDV_StardewValley_Mobile_VirtualJoypad_TappedButtonB_0600674e
...

{
  ...
  uVar3 = _UNK_1036d8970;
  if ((lVar4 != 0) && (uVar3 = _UNK_1036d8978, (undefined4 *)(lVar4 + 0x38) != (undefined4 *)0x0)) {
  ...
  pcVar1 = (code *)SoftwareBreakpoint(1,0x101fd4650);
  (*pcVar1)();
}
