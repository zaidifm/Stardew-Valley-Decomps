...
The iOS build is AOT-compiled. Managed assemblies provide rich metadata but most ordinary method implementations are AOT stubs.

This directory therefore separates:
...
- `manifests/` — coverage and AOT-module metadata.
