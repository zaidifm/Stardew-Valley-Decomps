	...
	public override void UpdateWhenCurrentLocation(GameTime time)
	{
		...
		if (Game1.shouldTimePass())
		{
			...
			if (stopWatch.ElapsedMilliseconds > 27692 && stopWatch.ElapsedMilliseconds < 55385)
			{
				...
				for (int num2 = 0; num2 < bubbles.Count; num2++)
				{
					bubbles[num2] = new Vector2(bubbles[num2].X, bubbles[num2].Y - 0.1f * (float)time.ElapsedGameTime.Milliseconds);
				}
			}
			...
			if (oldStopWatchTime < 64808f && stopWatch.ElapsedMilliseconds >= 64808)
			{
				for (int num3 = 0; num3 < 200; num3++)
				{
					sparkles.Add(new TemporaryAnimatedSprite
					{
						...
						animationLength = 9,
						interval = 100f,
						delayBeforeAnimationStart = num3 * 10,
