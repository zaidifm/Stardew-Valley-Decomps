...
public class AbandonedJojaMart : GameLocation
{
	...
	{
		if (Game1.netWorldState.Value.Bundles.TryGetValue(36, out var value) && !bundleMutex.IsLocked() && !Game1.eventUp && !Game1.MasterPlayer.hasOrWillReceiveMail("ccMovieTheater"))
		{
			bool[] array = value;
