...
public class IslandSouthEast : IslandLocation
{
	...
	public override void draw(SpriteBatch b)
	{
		...
		if (MermaidIsHere())
		{
			...
			b.Draw(mermaidSprites, Game1.GlobalToLocal(new Vector2(32f, 32f) * 64f + new Vector2(0f, -8f) * 4f), new Rectangle(304 + 28 * num, 592, 28, 36), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.0009f);
		}
	}
	...
	public void OnFishWalnut()
	{
		if (!fishedWalnut.Value && Game1.IsMasterGame)
		{
			...
			Game1.createItemDebris(ItemRegistry.Create("(O)73"), vector * 64f + new Vector2(0.5f, 1.5f) * 64f, 0, this, 0);
