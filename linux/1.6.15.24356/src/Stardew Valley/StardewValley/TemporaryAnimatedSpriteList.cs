...
public class TemporaryAnimatedSpriteList : IList<TemporaryAnimatedSprite>, ICollection<TemporaryAnimatedSprite>, IEnumerable<TemporaryAnimatedSprite>, IEnumerable
{
	...
	public void Clear()
	{
		foreach (TemporaryAnimatedSprite animatedSprite in AnimatedSprites)
		{
	...
	{
		TemporaryAnimatedSprite temporaryAnimatedSprite = AnimatedSprites[index];
		AnimatedSprites.RemoveAt(index);
		if (temporaryAnimatedSprite.Pooled)
		{
			temporaryAnimatedSprite.Pool();
		}
	}
