...
public class JumpingFish
{
	...
	public void Draw(SpriteBatch b)
	{
		...
		b.Draw(dataOrErrorItem.GetTexture(), Game1.GlobalToLocal(Game1.viewport, globalPosition), dataOrErrorItem.GetSourceRect(), Color.White, num, origin, 4f * num2, effects, position.Y / 10000f + 1E-06f);
