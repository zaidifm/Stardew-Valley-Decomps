...
public class FrameRateCounter : DrawableGameComponent
{
	...
	public override void Draw(GameTime gameTime)
	{
		...
		spriteBatch.Begin();
		spriteBatch.DrawString(Game1.dialogueFont, text, new Vector2(33f, 33f), Color.Black);
		spriteBatch.DrawString(Game1.dialogueFont, text, new Vector2(32f, 32f), Color.White);
		spriteBatch.End();
	}
}
