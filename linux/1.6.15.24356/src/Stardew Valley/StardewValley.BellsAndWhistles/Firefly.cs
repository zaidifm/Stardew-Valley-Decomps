...
public class Firefly : Critter
{
	...
	public Firefly(Vector2 position)
	{
		...
		light = new LightSource(GenerateLightSourceId(id), 4, position, (float)Game1.random.Next(4, 6) * 0.1f, Color.Purple * 0.8f, LightSource.LightContext.None, 0L, Game1.currentLocation.NameOrUniqueName);
		glowing = true;
