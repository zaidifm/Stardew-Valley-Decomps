...
public class Seagull : Critter
{
	...
	public override bool update(GameTime time, GameLocation environment)
	{
		...
		case 0:
		{
			int num3 = (moveLeft ? (-2) : 2);
			if (!environment.isCollidingPosition(getBoundingBox(num3, 0), Game1.viewport, isFarmer: false, 0, glider: false, null, pathfinding: false, projectile: false, ignoreCharacterRequirement: true))
			{
				position.X += num3;
			}
